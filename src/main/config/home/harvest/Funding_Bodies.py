#
# Rules script for FundingBodies
#
import time
...
class IndexData:
    ...
    def __newDoc(self):
        ...
        self.utils.add(self.index, "display_type", "funding_bodies")
    ...
    def __metadata(self):
        ...
        self.log.info("Lloyd:Is this record a new one? " + str(metadata.get("isNew")))

        data = json.getObject("data")
        self.utils.add(self.index, "dc_title", data.get("ID"))
        self.utils.add(self.index, "dc_description", data.get("ID"))
